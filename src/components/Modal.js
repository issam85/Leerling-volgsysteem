...
const Modal = ({ isOpen, onClose, title, children, footer, size = 'md', mobileFullScreen = false }) => {
  ...
  const modalClasses = mobileFullScreen 
    ? 'bg-white w-full h-full md:rounded-xl md:shadow-xl md:max-h-[90vh] md:w-auto md:max-w-2xl flex flex-col transform transition-all duration-300 animate-modalFadeIn'
